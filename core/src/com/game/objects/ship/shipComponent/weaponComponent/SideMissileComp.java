 ...
 */
public class SideMissileComp extends WeaponComponent implements WeaponComponentInterface {
    public SideMissileComp() {
        name = "Side missile upgrade";
    }
    ...
    public void fireMissile(Vector2 position, Vector2 velocity, Vector2 acceleration, float angle, float angularVelocity) {
        ...
        Missile missile1 = new Missile(position,velocity,acceleration,angle - (float)Math.toRadians(90),angularVelocity);
        Missile missile2 = new Missile(position,velocity,acceleration,angle + (float)Math.toRadians(90),angularVelocity);
